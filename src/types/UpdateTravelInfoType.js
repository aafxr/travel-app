 ...
 * @property {string} primary_id primary_entity_id путешествия
 ...
 * @property {TotalBySectionType[]} actual_list поле представляет список актуальных расходов вида: "id секции расходов" - "сумма расходов для данной секции"
 * @property {TotalBySectionType[]} planned_list поле представляет список актуальных расходов вида: "id секции расходов" - "сумма расходов для данной секции"
